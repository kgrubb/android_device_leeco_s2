...
public:
  ...
  int32_t getRawSize(cam_dimension_t &dim)
  {
    dim = m_rawSize;
    return NO_ERROR;
  };
  ...
  inline bool generateThumbFromMain() { return isUbiFocusEnabled() ||
                                               isChromaFlashEnabled() || isOptiZoomEnabled() || isUbiRefocus() || isHDREnabled() || isStillMoreEnabled() || isTruePortraitEnabled(); }
  ...
  int32_t setPreviewCallbackNeeded(bool enabled)
  {
    m_bPreviewCallbackNeeded = enabled;
    return 0;
  };
